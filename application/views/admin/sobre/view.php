...
<head>
    ...
    <title>Zamix | Painel de Controle - Sobre</title>
    <!-- Favicon icon -->
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Descrição da página sobre</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-about">
                                        <?php 
                                            $obj = new ArrayIterator($about);
                                            while($obj->valid()) :
                                        ?>
                                        <div class="form-row">
    ...
    ***********************************-->
    ...
    <script>
        ...
        $("#file-1").fileinput({
            ...
            initialPreview: [
                "<?php echo base_url() . 'assets/img/background/' . $b->current()->background; ?>"
            ],
