...
<head>
    ...
    <title>Zamix | Painel de Controle - Para Você</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Para Você</h4>
                            <p class="mb-0">Edite os dados da página Para Você de forma simples e rápida</p>
                        </div>
                    </div>
                </div>
				<div class="row">					
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Descrição da página para você</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-for-you-about">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <br>
                                                <input type="text" name="header-title" class="form-control" value="<?php echo $value->header_title; ?>" placeholder="Título do Topo" required>
                                                <input type="hidden" name="id" value="<?php echo $value->id; ?>">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Subtítulo do Topo</label>
                                                <br>
                                                <input type="text" name="header-subtitle" class="form-control" value="<?php echo $value->header_subtitle; ?>" placeholder="Subtítulo do Topo" required>
                                            </div>                                            
                                            <div class="form-group col-md-12">
                                                <label>Título <small>(Seção Tour Virtual)</small></label>
                                                <br>
                                                <input type="text" name="title" class="form-control" value="<?php echo $value->title; ?>" placeholder="Título (Seção Tour Virtual)" required>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Link Botão Tour Virtual</label>
                                                <br>
                                                <input type="text" name="link-btn-tou-virtual" class="form-control" value="<?php echo $value->btn_link; ?>" placeholder="Link Botão Tour Virtual" required>
                                            </div>
                                            <div class="form-group col-xl-12 col-xxl-12">
                                                <label>Descrição <small>(Seção Tour Virtual)</small></label>
    ...
    ***********************************-->
    ...
    <script>
        ...
        $("#file-1").fileinput({
            ...
            initialPreview: [
                "<?php echo base_url() . 'assets/img/background/' . $value->header_background; ?>"
            ],
