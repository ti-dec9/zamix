...
<head>
    ...
    <title>Zamix | Painel de Controle - Para Empresa</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Para Empresa</h4>
                            <p class="mb-0">Edite os dados da página Para Empresa de forma simples e rápida</p>
                        </div>
                    </div>
                </div>
				<div class="row">					
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Descrição da página Para Empresa</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-for-business-about">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-xl-12 col-xxl-12">
                                                ...
                                                <textarea class="summernote" name="description-1" required><?php echo $value->description_1; ?></textarea>
                                            </div>  
                                            <div class="form-group col-xl-12 col-xxl-12">
                                                <label>Descrição 2</label>
                                                <textarea class="summernote" name="description-2" required><?php echo $value->description_2; ?></textarea>
                                            </div>  
                                            <div class="form-group col-xl-12 col-xxl-12">
