...
<head>
    ...
    <title>Zamix | Painel de Controle - Transparência</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Transparência</h4>
                            <p class="mb-0">Edite os dados da página transparência de forma simples e rápida</p>
                        </div>
                    </div>
                </div>
				<div class="row">					
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Descrição da página transparência</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-transparent">
