...
<head>
    ...
    <title>Zamix | Painel de Controle - Blog .: Editar :.</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Blog</h4>
                            <p class="mb-0">Altere post de forma simples e rápida</p>
                        </div>
                    </div>
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Alteração de post</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-blog-post-update" enctype="multipart/form-data">
                                        <?php 
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label>Título</label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $obj->current()->title; ?>" placeholder="Título" required>
                                                <input type="hidden" name="id" value="<?php echo $obj->current()->id; ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Subtítulo</label>
                                                <input type="text" name="subtitle" class="form-control" value="<?php echo $obj->current()->subtitle; ?>" placeholder="Subtítulo">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Agendar Postagem <small>(Opcional)</small></label>
                                                <input type="text" name="agend-post" class="form-control date-format" value="<?php echo date('d/m/Y H:i:s', strtotime($obj->current()->agend_date_post)); ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Data de criação do post <small>(Opcional)</small></label>
                                                <input type="text" name="date-post-create" class="form-control date-format" value="<?php echo date('d/m/Y H:i:s', strtotime($obj->current()->created_at)); ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Categoria</label>
                                                <select id="cmb-category" name="category" class="form-control default-select" required>
                                            ...
                                            <div class="form-group col-xl-12 col-xxl-12">
                                                ...
                                                <textarea class="summernote" name="description" required><?php echo $obj->current()->description; ?></textarea>
                                            </div>
                                            <div class="form-group col-xl-12 col-xxl-12">
    ...
    ***********************************-->
    ...
    <script>
        ...
        $("#file-1").fileinput({
            ...
            initialPreview: [
                "<?php echo base_url() . 'assets/img/blog/' . $b->current()->image; ?>"
            ],
    ...
    <script>
        $('#cmb-category').val("<?php echo $b->current()->category; ?>");
    </script>
    <?php
        $b->next();
    endwhile;
