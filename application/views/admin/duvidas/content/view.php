                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Dúvidas</h4>
                            <p class="mb-0">Veja as perguntas frequentes da página Dúvidas</p>
                        </div>
                    </div>
                </div>			
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-end">
                                <a href="<?php echo base_url('admin/institucional/duvidas/novo_conteudo'); ?>" class="btn btn-secondary">Novo Conteúdo</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="<?php echo base_url(); ?>admin/institucional/duvidas/editar_conteudo/<?php echo $value->id; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<button type="button" data-id="<?php echo $value->id; ?>" class="btn btn-danger shadow btn-xs sharp btn-delete-faq-content"><i class="fa fa-trash"></i></button>
													</div>
												</td>
                                            </tr>
                                            <?php
