...
<head>
    ...
    <title>Zamix | Painel de Controle - Para Empresa .: Novo :.</title>
    <!-- Favicon icon -->
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Para Empresa</h4>
                            <p class="mb-0">Cadastre um novo plano</p>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/planos/paraempresa/novo'); ?>">Para Empresa</a></li>
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Novo Plano <br> <small class="text-muted" style="font-size: 12px; text-transform: initial;">Campos com (<span class="color-red">*</span>) são obrigatórios</small></h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-for-business-insert">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label>Nome <small class="color-red">*</small></label>
                                                <input type="text" name="name" class="form-control" placeholder="Ex: TurboMix10012²" required>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Nome Destaque<small class="color-red">*</small></label>
                                                <input type="text" name="name-featured" class="form-control" placeholder="Ex: 100 Mega" required>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>ID do Plano <small>(para mais detalhes, consulte o time de TI)</small> <small class="color-red">*</small></label>
                                                <input type="text" name="id-plan" class="form-control" placeholder="Ex: TurboMix10012²" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Tipo de Plano <small class="color-red">*</small></label>
                                                <select name="type-plan" class="form-control">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="value" class="form-control" placeholder="149,90" required>
                                            </div>
                                            ...
                                            <div class="form-group col-xl-12 col-xxl-12">
                                                ...
                                                <textarea class="summernote" name="obs"></textarea>
                                            </div>
                                            <div class="form-group col-xl-12 col-xxl-12">
                                                <label>Observações de após o vencimento <small>(ex: Após o vencimento R$ 219,90)</small></label>
                                                <textarea class="summernote" name="obs-after-expiration"></textarea>
                                            </div>
                                        </div>                                        
