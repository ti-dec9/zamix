...
<head>
    ...
    <title>Zamix | Painel de Controle - Para Você .: Novo :.</title>
    <!-- Favicon icon -->
			...
			<div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/planos/paravoce/novo'); ?>">Para você</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form id="frm-for-you-insert">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Nome <small class="color-red">*</small></label>
                                                <input type="text" name="name" class="form-control" placeholder="Ex: PREMIUM CASA P" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Nome Destaque <small class="color-red">*</small></label>
                                                <input type="text" name="name-featured" class="form-control" placeholder="Ex: CASA P" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>ID do Plano <small>(para mais detalhes, consulte o time de TI)</small> <small class="color-red">*</small></label>
                                                <input type="text" name="id-plan" class="form-control" placeholder="Ex: PremiumCasaP" required>
                                            </div>
                                            <div class="form-group col-md-6">
