...
<head>
    ...
    <title>Zamix | Painel de Controle - Planos .: Para Você :.</title>
    <!-- Favicon icon -->
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-end">
                                <a href="<?php echo base_url('admin/planos/paravoce/novo'); ?>" class="btn btn-secondary">Novo Plano</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="<?php echo base_url(); ?>admin/planos/paravoce/editar/<?php echo $value->id; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<button type="button" id="btn-delete-plan-for-you" data-id="<?php echo $value->id; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></button>
													</div>
												</td>
                                            </tr>
                                            <?php
