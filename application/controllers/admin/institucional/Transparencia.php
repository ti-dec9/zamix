...
class Transparencia extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('admin/Model_Transparencia');
    }
    ...
    public function index() {
        if (isset($_SESSION['session'])) :
            ...
            $this->load->view('admin/transparencia/view', $data);
        else :
    ...
    **********************/
    public function update() {   
        ...
        if ($this->upload->do_upload('image')) {            
            ...
            $this->_return = $this->Model_Transparencia->update($this->id, $this->_arrData);
            if ($this->_return) {
                echo 'TRUE';
            } else {
                echo 'FALSE';
