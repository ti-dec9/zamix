...
! function(e) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], e) : "object" == typeof module && module.exports ? module.exports = e(require("jquery")) : e(window.jQuery) }(function(e) {
    "use strict";
    e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, String.prototype.setTokens = function(e) { var i, t, a = this.toString(); for (i in e) e.hasOwnProperty(i) && (t = new RegExp("{" + i + "}", "g"), a = a.replace(t, e[i])); return a };
    var i, t;
    i = {
        ...
        compare: function(e, i, t) { return void 0 !== e && (t ? e === i : e.match(i)) },
        isIE: function(e) { if ("Microsoft Internet Explorer" !== navigator.appName) return !1; if (10 === e) return new RegExp("msie\\s" + e, "i").test(navigator.userAgent); var i, t = document.createElement("div"); return t.innerHTML = "<!--[if IE " + e + "]> <i></i> <![endif]-->", i = t.getElementsByTagName("i").length, document.body.appendChild(t), t.parentNode.removeChild(t), i },
        initModal: function(i) {
            var t = e("body");
            t.length && i.appendTo(t)
        },
        isEmpty: function(i, t) { return void 0 === i || null === i || 0 === i.length || t && "" === e.trim(i) },
        isArray: function(e) { return Array.isArray(e) || "[object Array]" === Object.prototype.toString.call(e) },
        ifSet: function(e, i, t) { return t = t || "", i && "object" == typeof i && e in i ? i[e] : t },
        ...
        getNum: function(e, i) { return i = i || 0, "number" == typeof e ? e : ("string" == typeof e && (e = parseFloat(e)), isNaN(e) ? i : e) },
        hasFileAPISupport: function() { return !(!window.File || !window.FileReader) },
        hasDragDropSupport: function() { var e = document.createElement("div"); return !i.isIE(9) && (void 0 !== e.draggable || void 0 !== e.ondragstart && void 0 !== e.ondrop) },
        hasFileUploadSupport: function() { return i.hasFileAPISupport() && window.FormData },
        addCss: function(e, i) { e.removeClass(i).addClass(i) },
        getElement: function(t, a, n) { return i.isEmpty(t) || i.isEmpty(t[a]) ? n : e(t[a]) },
        uniqId: function() { return Math.round((new Date).getTime() + 100 * Math.random()) },
        htmlEncode: function(e) { return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&apos;") },
        replaceTags: function(i, t) { var a = i; return t ? (e.each(t, function(e, i) { "function" == typeof i && (i = i()), a = a.split(e).join(i) }), a) : a },
        cleanMemory: function(e) {
            var t = e.is("img") ? e.attr("src") : e.find("source").attr("src");
            i.objUrl.revokeObjectURL(t)
        },
        findFileName: function(e) { var i = e.lastIndexOf("/"); return -1 === i && (i = e.lastIndexOf("\\")), e.split(e.substring(i, i + 1)).pop() },
        ...
        validateOrientation: function(e, t) {
            if (window.FileReader && window.DataView) {
                ...
                n.onloadend = function() { a = n.result, i.setOrientation(a, t) }, n.readAsArrayBuffer(e)
            }
        },
        adjustOrientedImage: function(e, i) {
            ...
            if (e.hasClass("is-portrait-gt4")) {
                ...
                e.css({ height: "auto", width: e.height() }), t = e.parent().offset().top, a = e.offset().top, n = t - a, e.css("margin-top", n)
            }
        }
    }, t = function(t, a) {
        var n = this;
        ...
        _initPreviewTemplates: function() {
            var t, a = this,
                ...
                o = r.tagAfter;
            e.each(n.previewContentTemplates, function(e, n) { i.isEmpty(a.previewTemplates[e]) && (t = r.tagBefore2, "generic" !== e && "image" !== e && "html" !== e && "text" !== e || (t = r.tagBefore1), a.previewTemplates[e] = t + n + o) })
        },
        _initPreviewCache: function() {
            ...
            t.previewCache = {
                ...
                init: function() {
                    ...
                    e.length > 0 && !i.isArray(e) && (e = e.split(t.initialPreviewDelimiter)), t.previewCache.data = { content: e, config: t.initialPreviewConfig, tags: t.initialPreviewThumbTags }
                },
                fetch: function() { return t.previewCache.data.content.filter(function(e) { return null !== e }) },
                count: function(e) { return t.previewCache.data && t.previewCache.data.content ? e ? t.previewCache.data.content.length : t.previewCache.fetch().length : 0 },
                get: function(a, n) {
                    var r, o, l, s, d, c, u, p = "init_" + a,
                        ...
                        w = function(e, a, n, r, o, l, s, d, c) { return d = " file-preview-initial " + i.SORT_CSS + (d ? " " + d : ""), t._generatePreviewTemplate(e, a, n, r, o, !1, null, d, l, s, c) };
                ...
                add: function(e, a, n, r) { var o, l = t.previewCache.data; return i.isArray(e) || (e = e.split(t.initialPreviewDelimiter)), r ? (o = l.content.push(e) - 1, l.config[o] = a, l.tags[o] = n) : (o = e.length - 1, l.content = e, l.config = a, l.tags = n), t.previewCache.data = l, o },
                set: function(e, a, n, r) {
                    var o, l, s = t.previewCache.data;
                    if (e && e.length && (i.isArray(e) || (e = e.split(t.initialPreviewDelimiter)), l = e.filter(function(e) { return null !== e }), l.length)) {
                        if (void 0 === s.content && (s.content = []), void 0 === s.config && (s.config = []), void 0 === s.tags && (s.tags = []), r) { for (o = 0; o < e.length; o++) e[o] && s.content.push(e[o]); for (o = 0; o < a.length; o++) a[o] && s.config.push(a[o]); for (o = 0; o < n.length; o++) n[o] && s.tags.push(n[o]) } else s.content = e, s.config = a, s.tags = n;
                ...
                footer: function(e, a, n) {
                    ...
                    var o, l = r.config[e],
                        ...
                        g = c === !1 && a;
                    return o = t._renderFileActions(!1, m, v, h, g, c, u, !0), t._getLayoutTemplate("footer").setTokens({ progress: t._renderThumbProgress(), actions: o, caption: s, size: t._getSize(n), width: d, indicator: "" })
                }
            }, t.previewCache.init()
        },
        ...
        _errorsExist: function() { var i, t = this; return t.$errorContainer.find("li").length ? !0 : (i = e(document.createElement("div")).html(t.$errorContainer.html()), i.find("span.kv-error-close").remove(), i.find("ul").remove(), !!e.trim(i.text()).length) },
        _errorHandler: function(e, i) {
            var t = this,
                a = e.target.error,
                n = function(e) { t._showError(e.replace("{name}", i)) };
        ...
        _getPreviewIcon: function(i) {
            var t, a = this,
                n = null;
            return i && i.indexOf(".") > -1 && (t = i.split(".").pop(), a.previewFileIconSettings && (n = a.previewFileIconSettings[t] || a.previewFileIconSettings[t.toLowerCase()] || null), a.previewFileExtSettings && e.each(a.previewFileExtSettings, function(e, i) { return a.previewFileIconSettings[e] && i(t) ? void(n = a.previewFileIconSettings[e]) : void 0 })), n
        },
        _parseFilePreviewIcon: function(e, i) {
            var t = this,
                a = t._getPreviewIcon(i) || t.previewFileIcon,
                n = e;
            return n.indexOf("{previewFileIcon}") > -1 && (n = n.setTokens({ previewFileIconClass: t.previewFileIconClass, previewFileIcon: a })), n
        },
        _raise: function(i, t) {
            var a = this,
                n = e.Event(i);
        ...
        _clearPreview: function() {
            var t = this,
                a = t.$preview,
                n = t.showUploadedThumbs ? a.find(i.FRAMES + ":not(.file-preview-success)") : a.find(i.FRAMES);
            n.each(function() {
                var t = e(this);
        ...
        _getModalContent: function() { var e = this; return e._getLayoutTemplate("modal").setTokens({ zoomFrameClass: e.frameClass, heading: e.msgZoomModalHeading, prev: e._getZoomButton("prev"), next: e._getZoomButton("next"), toggleheader: e._getZoomButton("toggleheader"), fullscreen: e._getZoomButton("fullscreen"), borderless: e._getZoomButton("borderless"), close: e._getZoomButton("close") }) },
        _listenModalEvent: function(e) {
            var t = this,
                a = t.$modal,
                n = function(e) { return { sourceEvent: e, previewId: a.data("previewId"), modal: a } };
        ...
        _initZoom: function() {
            var t, a = this,
                ...
                r = "#" + i.MODAL_ID;
            a.showPreview && (a.$modal = e(r), a.$modal && a.$modal.length || (t = e(document.createElement("div")).html(n).insertAfter(a.$container), a.$modal = e(r).insertBefore(t), t.remove()), i.initModal(a.$modal), a.$modal.html(a._getModalContent()), e.each(i.MODAL_EVENTS, function(e, i) { a._listenModalEvent(i) }))
        },
        _initZoomButtons: function() {
            var t, a, n = this,
                r = n.$modal.data("previewId") || "",
                o = n.$preview,
                l = o.find(i.FRAMES).toArray(),
                s = l.length,
                d = n.$modal.find(".btn-prev"),
                c = n.$modal.find(".btn-next");
            return l.length < 2 ? (d.hide(), void c.hide()) : (d.show(), c.show(), void(s && (t = e(l[0]), a = e(l[s - 1]), d.removeAttr("disabled"), c.removeAttr("disabled"), t.length && t.attr("id") === r && d.attr("disabled", !0), a.length && a.attr("id") === r && c.attr("disabled", !0))))
        },
        ...
        _setZoomContent: function(t, a) {
            ...
            r = y.attr("data-template") || "generic", n = y.find(".kv-file-content"), o = n.length ? n.html() : "", p = t.data("caption") || "",
                f = t.data("size") || "", l = p + " " + f, h.find(".kv-zoom-title").html(l), s = h.find(".kv-zoom-body"), h.removeClass("kv-single-content"), a ? (u = s.addClass("file-thumb-loading").clone().insertAfter(s), s.html(o).hide(), u.fadeOut("fast", function() { s.fadeIn("fast", function() { s.removeClass("file-thumb-loading") }), u.remove() })) : s.html(o), c = m.previewZoomSettings[r], c && (d = s.find(".kv-preview-data"), i.addCss(d, "file-zoom-detail"), e.each(c, function(e, i) { d.css(e, i), (d.attr("width") && "width" === e || d.attr("height") && "height" === e) && d.removeAttr(e) })), h.data("previewId", v);
            var E = s.find("img");
            E.length && i.adjustOrientedImage(E, !0), m._handler(g, "click", function() { m._zoomSlideShow("prev", v) }), m._handler(w, "click", function() { m._zoomSlideShow("next", v) }), m._handler(_, "click", function() { m._resizeZoomDialog(!0) }), m._handler(b, "click", function() { m._resizeZoomDialog(!1) }), m._handler(C, "click", function() {
                ...
                i.is(":visible") ? (e = i.outerHeight(!0), i.slideUp("slow", function() { a.find(".btn").appendTo(t), n(e) })) : (t.find(".btn").appendTo(a), i.slideDown("slow", function() { n() })), h.focus()
        ...
        _zoomSlideShow: function(t, a) {
            ...
            if (!s.attr("disabled")) {
                for (r = 0; c > r; r++)
                    if (e(d[r]).attr("id") === a) { o = "prev" === t ? r - 1 : r + 1; break }
                0 > o || o >= c || !d[o] || (n = e(d[o]), n.length && l._setZoomContent(n, !0), l._initZoomButtons(), l._raise("filezoom" + t, { previewId: a, modal: l.$modal }))
            }
        },
        _initZoomButton: function() {
            ...
            i.$preview.find(".kv-file-zoom").each(function() {
                var t = e(this);
                i._handler(t, "click", function() { i._zoomPreview(t) })
            })
        },
        _clearObjects: function(i) { i.find("video audio").each(function() { this.pause(), e(this).remove() }), i.find("img object div").each(function() { e(this).remove() }) },
        ...
        _resetPreviewThumbs: function(e) { var i, t = this; return e ? (t._clearPreview(), void t.clearStack()) : void(t._hasInitialPreview() ? (i = t.previewCache.out(), t.$preview.html(i.content), t._setInitThumbAttr(), t._setCaption(i.caption), t._initPreviewActions()) : t._clearPreview()) },
        ...
        _getOutData: function(e, i, t) { var a = this; return e = e || {}, i = i || {}, t = t || a.filestack.slice(0) || {}, { form: a.formdata, files: t, filenames: a.filenames, filescount: a.getFilesCount(), extra: a._getExtraData(), response: i, reader: a.reader, jqXHR: e } },
        ...
        _getThumbs: function(e) { return e = e || "", this.$preview.find(i.FRAMES + ":not(.file-preview-initial)" + e) },
        ...
        _initSuccessThumbs: function() {
            ...
            t.showPreview && t._getThumbs(i.FRAMES + ".file-preview-success").each(function() {
                ...
                r.removeAttr("disabled"), t._handler(r, "click", function() {
                    ...
                    i.cleanMemory(a), r !== !1 && a.fadeOut("slow", function() { i.cleanZoomCache(n.find("#zoom-" + e)), a.remove(), n.find(i.FRAMES).length || t.reset() })
                })
            })
        },
        ...
        _uploadExtra: function(i, t) {
            ...
            0 !== n.length && e.each(n, function(e, i) { a.formdata.append(e, i) })
        },
        _uploadSingle: function(t, a, n) {
            var r, o, l, s, d, c, u, p, f, m, v = this,
                ...
                C = { id: w, index: t };
            v.formdata = g, v.showPreview && (o = e("#" + w + ":not(.file-preview-initial)"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), b.removeClass("hide")), 0 === h || !_ || s && s.hasClass("disabled") || v._abort(C) || (m = function(e, i) { v.updateStack(e, void 0), v.uploadLog.push(i), v._checkAsyncComplete() && (v.fileBatchCompleted = !0) }, l = function() {
            ...
            }, c = function(a) { r = v._getOutData(a), v.fileBatchCompleted = !1, v.showPreview && (o.hasClass("file-preview-success") || (v._setThumbStatus(o, "Loading"), i.addCss(o, "file-uploading")), s.attr("disabled", !0), d.attr("disabled", !0)), n || v.lock(), v._raise("filepreupload", [r, w, t]), e.extend(!0, C, r), v._abort(C) && (a.abort(), v._setProgressCancelled()) }, u = function(a, l, d) {
                var c = v.showPreview && o.attr("id") ? o.attr("id") : w;
                r = v._getOutData(d, a), e.extend(!0, C, r), setTimeout(function() { i.isEmpty(a) || i.isEmpty(a.error) ? (v.showPreview && (v._setThumbStatus(o, "Success"), s.hide(), v._initUploadSuccess(a, o, n), v._setProgress(101, b)), v._raise("fileuploaded", [r, c, t]), n ? m(t, c) : v.updateStack(t, void 0)) : (v._showUploadError(a.error, C), v._setPreviewError(o, t), n && m(t, c)) }, 100)
            }, p = function() { setTimeout(function() { v.showPreview && (s.removeAttr("disabled"), d.removeAttr("disabled"), o.removeClass("file-uploading")), n ? l() : (v.unlock(!1), v._clearFileInput()), v._initSuccessThumbs() }, 100) }, f = function(i, r, l) {
                var s = v.ajaxOperations.uploadThumb,
                    d = v._parseError(s, i, l, n ? a[t].name : null);
                setTimeout(function() { n && m(t, w), v.uploadStatus[w] = 100, v._setPreviewError(o, t), e.extend(!0, C, v._getOutData(i)), v._setProgress(101, b, v.msgAjaxProgressError.replace("{operation}", s)), v._showUploadError(d, C) }, 100)
        ...
        _uploadBatch: function() {
            ...
            l.formdata = new FormData, 0 !== d && u && !l._abort(c) && (o = function() { e.each(s, function(e) { l.updateStack(e, void 0) }), l._clearFileInput() }, t = function(t) {
                l.lock();
            ...
            }, r = function() { l.unlock(), l._initSuccessThumbs(), l._clearFileInput(), l._raise("filebatchuploadcomplete", [l.filestack, l._getExtraData()]) }, n = function(i, t, a) {
            ...
            }, e.each(s, function(e, t) { i.isEmpty(s[e]) || l.formdata.append(l.uploadFileAttr, t, l.filenames[e]) }), l._ajaxSubmit(t, a, r, n))
        },
        _uploadExtraOnly: function() {
            ...
            }, a = function() { r.unlock(), r._clearFileInput(), r._raise("filebatchuploadcomplete", [r.filestack, r._getExtraData()]) }, n = function(e, i, t) {
        ...
        _deleteFileIndex: function(t) {
            ...
            "init_" === n.substring(0, 5) && (n = parseInt(n.replace("init_", "")), a.initialPreview = i.spliceArray(a.initialPreview, n), a.initialPreviewConfig = i.spliceArray(a.initialPreviewConfig, n), a.initialPreviewThumbTags = i.spliceArray(a.initialPreviewThumbTags, n), a.$preview.find(i.FRAMES).each(function() {
                var i = e(this),
                    t = i.attr("data-fileindex");
            ...
            t.showPreview && (t._initZoomButton(), a.find(i.FRAMES + " .kv-file-remove").each(function() {
                ...
                t._handler(s, "click", function() {
                    return l = t._raise("filepreremove", [c, u]), l !== !1 && t._validateMinCount() ? (n = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow", function() {
                        i.cleanZoomCache(a.find("#zoom-" + c)), t.updateStack(u, void 0), t._clearObjects(d), d.remove(), c && n && t.$errorContainer.find('li[data-file-id="' + c + '"]').fadeOut("fast", function() { e(this).remove(), t._errorsExist() || t._resetErrors() }), t._clearFileInput();
        ...
        _initPreviewActions: function() {
            ...
            t._initZoomButton(), a.find(r).each(function() {
                ...
                if (!i.isEmpty(l) && void 0 !== s) {
                    ...
                    v = parseInt(v.replace("init_", "")), u = i.isEmpty(m.config) && i.isEmpty(m.config[v]) ? null : m.config[v], p = i.isEmpty(u) || i.isEmpty(u.extra) ? n : u.extra, "function" == typeof p && (p = p()), c = { id: r.attr("id"), key: s, extra: p }, d = e.extend(!0, {}, {
                        url: l,
                        type: "POST",
                        dataType: "json",
                        data: e.extend(!0, {}, { key: s }, p),
                        beforeSend: function(e) { t.ajaxAborted = !1, t._raise("filepredelete", [s, e, p]), t.ajaxAborted ? e.abort() : (i.addCss(f, "file-uploading"), i.addCss(r, "disabled")) },
                        success: function(e, n, l) { var d, u; return i.isEmpty(e) || i.isEmpty(e.error) ? (v = parseInt(f.attr("data-fileindex").replace("init_", "")), t.previewCache.unset(v), d = t.previewCache.count(), u = d > 0 ? t._getMsgSelected(d) : "", t._deleteFileIndex(f), t._setCaption(u), t._raise("filedeleted", [s, l, p]), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function() { i.cleanZoomCache(a.find("#zoom-" + f.attr("id"))), t._clearObjects(f), f.remove(), o(), d || 0 !== t.getFileStack().length || (t._setCaption(""), t.reset()) })) : (c.jqXHR = l, c.response = e, t._showError(e.error, c, "filedeleteerror"), f.removeClass("file-uploading"), r.removeClass("disabled"), void o()) },
                    ...
                    }, t.ajaxDeleteSettings), t._handler(r, "click", function() { return t._validateMinCount() ? void e.ajax(d) : !1 })
                }
            })
        },
        _hideFileIcon: function() { this.overwriteInitial && this.$captionContainer.find(".kv-caption-icon").hide() },
        _showFileIcon: function() { this.$captionContainer.find(".kv-caption-icon").show() },
        _getSize: function(i) {
            var t, a, n, r = this,
                o = parseFloat(i),
                l = r.fileSizeGetter;
                    ...
                    _.length && l.autoOrientImage ? i.validateOrientation(t, function(e) {
                        if (e) {
                            var a = f.find("#zoom-" + n + " img"),
                                r = "rotate-" + e;
                            e > 4 && (r += _.width() > _.height() ? " is-portrait-gt4" : " is-landscape-gt4"), i.addCss(_, r), i.addCss(a, r), l._raise("fileimageoriented", { $img: _, file: t })
                        }
                        l._validateImage(n, c, h, v), i.adjustOrientedImage(_)
                    }) : l._validateImage(n, c, h, v)
        ...
        _slugDefault: function(e) { return i.isEmpty(e) ? "" : String(e).replace(/[\-\[\]\/\{}:;#%=\(\)\*\+\?\\\^\$\|<>&"']/g, "_") },
        _readFiles: function(t) {
            ...
            var a, n = this,
                ...
                y = function(i, r, o, l) {
                    ...
                    return n._previewDefault(r, o, !0), n.isUploadable && (n.addToStack(void 0), setTimeout(function() { a(l + 1) }, 100)), n._initFileActions(), n.removeFromPreviewOnError && e("#" + o).remove(), n.isUploadable ? n._showUploadError(i, s) : n._showError(i, d)
                };
            n.loadedImages = [], n.totalImagesCount = 0, e.each(t, function(e, i) {
                ...
                var E, T, x, S, F, I, k, P, z, A, $ = v + e,
                    ...
                    Z = "";
                if (g > 0)
                    for (S = 0; g > S; S++) P = h[S], z = n.msgFileTypes[P] || P, Z += 0 === S ? z : ", " + z;
                if (j === !1) return void a(e + 1);
                if (0 === j.length) return F = n.msgInvalidFileName.replace("{name}", i.htmlEncode(U.name)), void(n.isError = y(F, U, D, e));
                if (i.isEmpty(w) || (L = new RegExp("\\.(" + w.join("|") + ")$", "i")), x = R.toFixed(2), n.maxFileSize > 0 && R > n.maxFileSize) return F = n.msgSizeTooLarge.setTokens({ name: j, size: x, maxSize: n.maxFileSize }), void(n.isError = y(F, U, D, e));
                if (null !== n.minFileSize && R <= i.getNum(n.minFileSize)) return F = n.msgSizeTooSmall.setTokens({ name: j, size: x, minSize: n.minFileSize }), void(n.isError = y(F, U, D, e));
                if (!i.isEmpty(h) && i.isArray(h)) { for (S = 0; S < h.length; S += 1) I = h[S], A = m[I], O += A && "function" == typeof A && A(U.type, U.name) ? 1 : 0; if (0 === O) return F = n.msgInvalidFileType.setTokens({ name: j, types: Z }), void(n.isError = y(F, U, D, e)) }
                return 0 !== O || i.isEmpty(w) || !i.isArray(w) || i.isEmpty(L) || (k = i.compare(j, L), O += i.isEmpty(k) ? 0 : k.length, 0 !== O) ? n.showPreview ? !C && R > b ? (n.addToStack(U), s.addClass("file-thumb-loading"), n._previewDefault(U, D), n._initFileActions(), n._updateFileDetails(f), void a(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function(e) { n._errorHandler(e, j) }, l.onload = function(i) { n._previewFile(e, U, i, D, M), n._initFileActions() }, l.onloadend = function() { F = u.setTokens({ index: e + 1, files: f, percent: 50, name: j }), setTimeout(function() { d.html(F), n._updateFileDetails(f), a(e + 1) }, 100), n._raise("fileloaded", [U, D, e, l]) }, l.onprogress = function(i) {
                    if (i.lengthComputable) {
                        var t = i.loaded / i.total * 100,
                            a = Math.ceil(t);
                        F = u.setTokens({ index: e + 1, files: f, percent: a, name: j }), setTimeout(function() { d.html(F) }, 100)
                    }
                }, E = m.text, T = m.image, E(U.type, j) ? l.readAsText(U, n.textEncoding) : T(U.type, j) ? l.readAsDataURL(U) : l.readAsArrayBuffer(U)) : (n._previewDefault(U, D), setTimeout(function() { a(e + 1), n._updateFileDetails(f) }, 100), n._raise("fileloaded", [U, D, e, l])), void n.addToStack(U)) : (n.addToStack(U), setTimeout(function() { a(e + 1) }, 100), void n._raise("fileloaded", [U, D, e, l])) : (F = n.msgInvalidFileExtension.setTokens({ name: j, extensions: _ }), void(n.isError = y(F, U, D, e)))
        ...
        _setProgress: function(e, t, a) {
            ...
            t = t || r.$progress, i.isEmpty(d) || (n = l && o > l && 100 >= e ? d.setTokens({ percent: l, status: r.msgUploadThreshold }) : d.setTokens({ percent: o, status: e > 100 ? r.msgUploadEnd : o + "%" }), t.html(n), a && t.find('[role="progressbar"]').html(a))
        },
        ...
        _setAsyncUploadStatus: function(i, t, a) {
            var n = this,
                r = 0;
            n._setProgress(t, e("#" + i).find(".file-thumb-progress")), n.uploadStatus[i] = t, e.each(n.uploadStatus, function(e, i) { r += i }), n._setProgress(Math.floor(r / a))
        },
        ...
        _getFileIds: function(e) { var i = this; return i.fileids.filter(function(i) { return e ? void 0 !== i : void 0 !== i && null !== i }) },
        _getFileNames: function(e) { var i = this; return i.filenames.filter(function(i) { return e ? void 0 !== i : void 0 !== i && null !== i }) },
        ...
        _checkDimensions: function(e, t, a, n, r, o, l) {
            var s, d, c, u, p = this,
                f = "Small" === t ? "min" : "max",
                m = p[f + "Image" + o];
            !i.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === t ? d >= m : m >= d, u || (s = p["msgImage" + o + t].setTokens({ name: r, size: m }), p._showUploadError(s, l), p._setPreviewError(n, e, null)))
        },
        _validateImage: function(e, i, t, a) {
            var n, r, o, l = this,
                ...
                u = d.find("img");
            i = i || "Untitled", u.length && l._handler(u, "load", function() { r = d.width(), o = s.width(), r > o && (u.css("width", "100%"), d.css("width", "97%")), n = { ind: c, id: e }, l._checkDimensions(c, "Small", u, d, i, "Width", n), l._checkDimensions(c, "Small", u, d, i, "Height", n), l.resizeImage || (l._checkDimensions(c, "Large", u, d, i, "Width", n), l._checkDimensions(c, "Large", u, d, i, "Height", n)), l._raise("fileimageloaded", [e]), l.loadedImages.push({ ind: c, img: u, thumb: d, pid: e, typ: t, siz: a, validated: !1 }), l._validateAllImages() })
        },
        ...
        _getResizedImage: function(i, t, a) {
            var n, r, o, l, s = this,
                ...
                p = 1,
                f = s.maxImageWidth || c,
                m = s.maxImageHeight || u,
                v = !(!c || !u),
                h = s.imageCanvas,
                g = s.imageCanvasContext,
                w = i.typ,
                _ = i.pid,
                b = i.ind,
                C = i.thumb;
            if (o = function(e, i, t) { s.isUploadable ? s._showUploadError(e, i, t) : s._showError(e, i, t), s._setPreviewError(C, b) }, (!s.filestack[b] || !v || f >= c && m >= u) && (v && s.filestack[b] && s._raise("fileimageresized", [_, b]), t.val++, t.val === a && s._raise("fileimagesresized"), !v)) return void o(s.msgImageResizeError, { id: _, index: b }, "fileimageresizeerror");
            w = w || s.resizeDefaultImageType, n = c > f, r = u > m, p = "width" === s.resizePreference ? n ? f / c : r ? m / u : 1 : r ? m / u : n ? f / c : 1, s._resetCanvas(), c *= p, u *= p, h.width = c, h.height = u;
            try { g.drawImage(d, 0, 0, c, u), h.toBlob(function(e) { s.filestack[b] = e, s._raise("fileimageresized", [_, b]), t.val++, t.val === a && s._raise("fileimagesresized", [void 0, void 0]), e instanceof Blob || o(s.msgImageResizeError, { id: _, index: b }, "fileimageresizeerror") }, w, s.resizeQuality) } catch (y) { t.val++, t.val === a && s._raise("fileimagesresized", [void 0, void 0]), l = s.msgImageResizeException.replace("{errors}", y.message), o(l, { id: _, index: b }, "fileimageresizeexception") }
        },
        ...
        _renderMain: function() {
            var e = this,
                ...
                a = e.showPreview ? e._getLayoutTemplate("preview").setTokens({ "class": e.previewClass, dropClass: i }) : "",
        ...
        _renderButton: function(e) {
            ...
            return n += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", i.isEmpty(l) || (l = ' <span class="' + t.buttonLabelClass + '">' + l + "</span>"), a.setTokens({ type: d, css: n, title: r, status: s, icon: o, label: l })
        },
        _renderThumbProgress: function() { var e = this; return '<div class="file-thumb-progress hide">' + e.progressTemplate.setTokens({ percent: "0", status: e.msgUploadBegin }) + "</div>" },
        _renderFileFooter: function(e, t, a, n) {
            ...
            return t = o._getSize(t), r = o.isUploadable ? p.setTokens({ actions: o._renderFileActions(c, s, u, d, !1, !1, !1), caption: e, size: t, width: a, progress: o._renderThumbProgress(), indicator: h }) : p.setTokens({ actions: o._renderFileActions(!1, !1, u, d, !1, !1, !1), caption: e, size: t, width: a, progress: "", indicator: h }), r = i.replaceTags(r, o.previewThumbTags)
        },
        _renderFileActions: function(e, i, t, a, n, r, o, l) {
            ...
            return i && (p = d._getLayoutTemplate("actionDelete").setTokens({ removeClass: _, removeIcon: g.removeIcon, removeTitle: g.removeTitle, dataUrl: c, dataKey: u })), e && (f = d._getLayoutTemplate("actionUpload").setTokens({ uploadClass: g.uploadClass, uploadIcon: g.uploadIcon, uploadTitle: g.uploadTitle })), t && (m = d._getLayoutTemplate("actionZoom").setTokens({ zoomClass: g.zoomClass, zoomIcon: g.zoomIcon, zoomTitle: g.zoomTitle })), a && l && (s = "drag-handle-init " + g.dragClass, v = d._getLayoutTemplate("actionDrag").setTokens({ dragClass: s, dragTitle: g.dragTitle, dragIcon: g.dragIcon })), h.setTokens({ "delete": p, upload: f, zoom: m, drag: v, other: w })
        },
        _browse: function(e) {
            var i = this;
        ...
        _resetFileStack: function() {
            ...
            t._getThumbs().each(function() {
                var l, s = e(this),
                    ...
                    c = t.filestack[d],
                    u = s.attr("id");
                "-1" !== d && -1 !== d && (void 0 !== c ? (n[a] = c, r[a] = t._getFileName(c), o[a] = t._getFileId(c), s.attr({ id: t.previewInitId + "-" + a, "data-fileindex": a }), a++) : (l = "uploaded-" + i.uniqId(), s.attr({ id: l, "data-fileindex": "-1" }), t.$preview.find("#zoom-" + u).attr("id", "zoom-" + l)))
            }), t.filestack = n, t.filenames = r, t.fileids = o
        },
        clearStack: function() { var e = this; return e.filestack = [], e.filenames = [], e.fileids = [], e.$element },
        updateStack: function(e, i) { var t = this; return t.filestack[e] = i, t.filenames[e] = t._getFileName(i), t.fileids[e] = i && t._getFileId(i) || null, t.$element },
        addToStack: function(e) { var i = this; return i.filestack.push(e), i.filenames.push(i._getFileName(e)), i.fileids.push(i._getFileId(e)), i.$element },
        getFileStack: function(e) { var i = this; return i.filestack.filter(function(i) { return e ? void 0 !== i : void 0 !== i && null !== i }) },
        getFilesCount: function() {
            var e = this,
                i = e.isUploadable ? e.getFileStack().length : e.$element.get(0).files.length;
            return e._getFileCount(i)
        },
        lock: function() { var e = this; return e._resetErrors(), e.disable(), e.showRemove && i.addCss(e.$container.find(".fileinput-remove"), "hide"), e.showCancel && e.$container.find(".fileinput-cancel").removeClass("hide"), e._raise("filelock", [e.filestack, e._getExtraData()]), e.$element },
        unlock: function(e) { var t = this; return void 0 === e && (e = !0), t.enable(), t.showCancel && i.addCss(t.$container.find(".fileinput-cancel"), "hide"), t.showRemove && t.$container.find(".fileinput-remove").removeClass("hide"), e && t._resetFileStack(), t._raise("fileunlock", [t.filestack, t._getExtraData()]), t.$element },
        cancel: function() {
            var i, t = this,
                a = t.ajaxRequests,
                n = a.length;
        ...
        clear: function() { var t, a = this; if (a._raise("fileclear")) return a.$btnUpload.removeAttr("disabled"), a._getThumbs().find("video,audio,img").each(function() { i.cleanMemory(e(this)) }), a._resetUpload(), a.clearStack(), a._clearFileInput(), a._resetErrors(!0), a._hasInitialPreview() ? (a._showFileIcon(), a._resetPreview(), a._initPreviewActions(), a.$container.removeClass("file-input-new")) : (a._getThumbs().each(function() { a._clearObjects(e(this)) }), a.isUploadable && (a.previewCache.data = {}), a.$preview.html(""), t = !a.overwriteInitial && a.initialCaption.length > 0 ? a.initialCaption : "", a.$caption.html(t), a.$caption.attr("title", ""), i.addCss(a.$container, "file-input-new"), a._validateDefaultPreview()), 0 === a.$container.find(i.FRAMES).length && (a._initCaption() || a.$captionContainer.find(".kv-caption-icon").hide()), a._hideFileIcon(), a._raise("filecleared"), a.$captionContainer.focus(), a._setFileDropZoneTitle(), a.$element },
        reset: function() { var e = this; if (e._raise("filereset")) return e._resetPreview(), e.$container.find(".fileinput-filename").text(""), i.addCss(e.$container, "file-input-new"), (e.$preview.find(i.FRAMES).length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"), e._setFileDropZoneTitle(), e.clearStack(), e.formdata = {}, e.$element },
        ...
        zoom: function(t) {
            var a = this,
                n = e("#" + t),
                r = a.$modal;
            return n.length ? (i.initModal(r), r.html(a._getModalContent()), a._setZoomContent(n), r.modal("show"), void a._initZoomButtons()) : void a._log('Cannot zoom to detailed preview! Invalid frame with id: "' + t + '".')
        },
